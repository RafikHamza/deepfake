...
def create_root(start: Callable[[], None], destroy: Callable[[], None]) -> ctk.CTk:
    ...
    donate_label = ctk.CTkLabel(root, text='^_^ TIU ^_^', justify='center', cursor='hand2')
    donate_label.place(relx=0.1, rely=0.95, relwidth=0.8)
    donate_label.configure(text_color=ctk.ThemeManager.theme.get('TIU').get('text_color'))
    donate_label.bind('<Button>', lambda event: webbrowser.open('https://github.com/rafikhamza'))
